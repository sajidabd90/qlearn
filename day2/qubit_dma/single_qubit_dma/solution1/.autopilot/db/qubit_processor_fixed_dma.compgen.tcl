...
set id 1
set name qubit_processor_fixed_dma_am_addmul_16s_16s_13ns_29_4_1
...
set ce_signed 0
set out_width 29
set arg_lists {i0 {16 1 +} i1 {16 1 +} s {17 1 +} i2 {13 0 +} p {29 1 +} c_expval {c} acc {0} }
set TrueReset 0
...
set id 3
set name qubit_processor_fixed_dma_am_submul_16s_16s_13ns_29_4_1
set corename simcore_am
set op am
set stage_num 4
set clk_width 1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 7 \
			corename qubit_processor_fixed_dma_control_axilite \
			name qubit_processor_fixed_dma_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler qubit_processor_fixed_dma_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 16
set RegSliceName qubit_processor_fixed_dma_regslice_both
set RegSliceInstName qubit_processor_fixed_dma_regslice_both_U
set CoreName ap_simcore_qubit_processor_fixed_dma_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix qubit_processor_fixed_dma_ \
    sliceTypeList 0\
}"
} else {
