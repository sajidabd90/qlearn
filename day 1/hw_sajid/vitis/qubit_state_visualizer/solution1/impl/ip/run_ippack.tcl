...
set Library     "hls"
set IPName      "qubit_processor_fixed"
set Version     "1.0"
set DisplayName "qubit_visualizer"
set Revision    "2114208976"
...
set xo_kernel_name "qubit_processor_fixed"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/soulbird/hls_prac/qc/vitis/qubit_state_visualizer/solution1"
set debug_dir "/home/soulbird/hls_prac/qc/vitis/qubit_state_visualizer/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {qubit_processor_fixed_mul_17s_14ns_29_4_1
...
## Variables
set Top "qubit_processor_fixed"
set TopNoPrefix "qubit_processor_fixed"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 operation W 0x0 "Data signal of operation" {{0 2 operation W 0 "Bit 1 to 0 of operation"} {2 30 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 in_alpha_real W 0x0 "Data signal of in_alpha_real" {{0 16 in_alpha_real W 0 "Bit 15 to 0 of in_alpha_real"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 in_alpha_imag W 0x0 "Data signal of in_alpha_imag" {{0 16 in_alpha_imag W 0 "Bit 15 to 0 of in_alpha_imag"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 in_beta_real W 0x0 "Data signal of in_beta_real" {{0 16 in_beta_real W 0 "Bit 15 to 0 of in_beta_real"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 in_beta_imag W 0x0 "Data signal of in_beta_imag" {{0 16 in_beta_imag W 0 "Bit 15 to 0 of in_beta_imag"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 out_alpha_real R 0x0 "Data signal of out_alpha_real" {{0 16 out_alpha_real R 0 "Bit 15 to 0 of out_alpha_real"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c out_alpha_real_ctrl R 0x0 "Control signal of out_alpha_real" {{0 1 out_alpha_real_ap_vld R 0 "Control signal out_alpha_real_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 out_alpha_imag R 0x0 "Data signal of out_alpha_imag" {{0 16 out_alpha_imag R 0 "Bit 15 to 0 of out_alpha_imag"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x4c out_alpha_imag_ctrl R 0x0 "Control signal of out_alpha_imag" {{0 1 out_alpha_imag_ap_vld R 0 "Control signal out_alpha_imag_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 out_beta_real R 0x0 "Data signal of out_beta_real" {{0 16 out_beta_real R 0 "Bit 15 to 0 of out_beta_real"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x5c out_beta_real_ctrl R 0x0 "Control signal of out_beta_real" {{0 1 out_beta_real_ap_vld R 0 "Control signal out_beta_real_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 out_beta_imag R 0x0 "Data signal of out_beta_imag" {{0 16 out_beta_imag R 0 "Bit 15 to 0 of out_beta_imag"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c out_beta_imag_ctrl R 0x0 "Control signal of out_beta_imag" {{0 1 out_beta_imag_ap_vld R 0 "Control signal out_beta_imag_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 6 II 1}
